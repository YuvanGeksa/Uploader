...
export default function Page(){
  ...
  <div className="field">
    ...
    <input className="input" value={owner} onChange={(e)=>setOwner(e.target.value)} placeholder="misal: Yopandelreyz" spellCheck={false} />
    <div className="hint">Ini pemilik repo (user/organization).</div>
  </div>
  <div className="field">
    <div className="label">Repository</div>
    <input className="input" value={repo} onChange={(e)=>setRepo(e.target.value)} placeholder="misal: test-upload" spellCheck={false} />
...
<div className="hint">
  Upload akan berhasil kalau token kamu punya akses <b>write</b> ke repo: <b>{fullRepo}</b>
        ...
        {step === 3 && (
          <div className="card">
            <div className="kv">
              <div className="k">Repo</div><div className="v">{ALLOWED_OWNER}/{ALLOWED_REPO}</div>
